...
// For comphrensions provide a convenient syntactic abstraction for these
// operations.
...
// If we look both compute the List(2,3,4), coincidentally
...
// These implications are broad and mean we can use this syntax
